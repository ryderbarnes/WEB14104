...
//use this function to search for recipes on edamam api
//pass the vavlu that the user has typed in
//one we get something back from api, run the displayrecipes function.
...
function displayRecipes(responseJSON){
    ...
    while (counter < total) {
        ...
        //use the template function to get list item
